...
parser.add_argument('--Nbins_w',type=int,default=20,dest='Nbins_w')
parser.add_argument('--Nbins_d',type=int,default=20,dest='Nbins_d')
parser.add_argument('--Nbins_v',type=int,default=20,dest='Nbins_v')
parser.add_argument('--Nbins_c',type=int,default=40,dest='Nbins_c')
parser.add_argument('--Nbins_a',type=int,default=40,dest='Nbins_a')
parser.add_argument('--Nbins_r',type=int,default=40,dest='Nbins_r')
...
def calc_all_observables(param):
    ...
    pos_gals_d = return_xyz_formatted_array(*(model.mock.galaxy_table[ax] for ax in 'xyz'), \
            velocity=model.mock.galaxy_table['vz'], velocity_distortion_dimension='z', period=Lbox) ##redshift space distorted
