...
parser.add_argument('--Nbins_d',type=int,default=25,dest='Nbins_d')
parser.add_argument('--Nbins_v',type=int,default=25,dest='Nbins_v')
parser.add_argument('--Nbins_c',type=int,default=25,dest='Nbins_c')
parser.add_argument('--Nbins_a',type=int,default=25,dest='Nbins_a')
parser.add_argument('--Nbins_r',type=int,default=25,dest='Nbins_r')
